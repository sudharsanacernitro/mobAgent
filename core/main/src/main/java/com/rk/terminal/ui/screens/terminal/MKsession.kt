...
public object MkSession {
    fun createSession(
        ...
        with(activity) {
            ...
            val shell = if (pendingCommand == null) {
                args = if (workingMode == 0){ // 0 for alpine
    ...
    fun createSession(
        activity: MainActivity,  session_id: String,workingMode:Int, sessionType : Int
        ...
        with(activity) {
            ...
            if( sessionType == 0 ) {
                ...
                return TerminalSynchronousSessionHandler(
                    shell,
                    workingDir,
                    args,
                    env.toTypedArray(),
                ...
                return TerminalAsynchronousSessionHandler(
                    shell,
                    workingDir,
                    args,
                    env.toTypedArray(),
